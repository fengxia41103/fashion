...
urlpatterns = patterns(
    ...
    url(r'^so/fullfills/$', views.MySalesOrderFullfillmentList.as_view(),
        name='so_fullfill_list'),
    url(r'^so/fullfill/add/(?P<pk>\d+)/$',
        views.MySalesOrderFullfillmentAdd.as_view(), name='so_fullfill_add'),
    url(r'^so/fullfill/(?P<pk>\d+)/$',
        views.MySalesOrderFullfillmentDetail.as_view(), name='so_fullfill_detail'),
    url(r'^so/fullfill/edit/(?P<pk>\d+)/$',
        views.MySalesOrderFullfillmentEdit.as_view(), name='so_fullfill_edit'),
    url(r'^so/fullfill/delete/(?P<pk>\d+)/$',
        views.MySalesOrderFullfillmentDelete.as_view(), name='so_fullfill_delete'),
    url(r'^so/fullfill/review/(?P<pk>\d+)/$',
        views.MySalesOrderFullfillmentReview.as_view(), name='so_fullfill_review'),
    url(r'^so/fullfill/review/batch/(?P<pk>\d+)/$',
        views.MySalesOrderFullfillmentReviewBatch.as_view(), name='so_fullfill_review_batch'),
    ...
    url(r'^po/fullfills/$', views.MyPOFullfillmentList.as_view(),
        name='po_fullfill_list'),
    url(r'^po/fullfill/(?P<pk>\d+)/$',
        views.MyPOFullfillmentDetail.as_view(), name='po_fullfill_detail'),
    url(r'^po/fullfill/review/(?P<pk>\d+)/$',
        views.MyPOFullfillmentReview.as_view(), name='po_fullfill_review'),
    url(r'^po/fullfill/edit/(?P<pk>\d+)/$',
        views.MyPOFullfillmentEdit.as_view(), name='po_fullfill_edit'),
    url(r'^po/fullfill/delete/(?P<pk>\d+)/$',
        views.MyPOFullfillmentDelete.as_view(), name='po_fullfill_delete'),
    ...
    url(r'^report/top/fullfill/profit/product/(?P<top>\d+)/$',
        views.ReportTopProductByFullfillProfit.as_view(), name='top_fullfill_profit_product_report'),
    url(r'^report/top/so/qty/balance/(?P<top>\d+)/$',
        views.ReportTopSOByQtyBalance.as_view(), name='top_so_qty_balance_report'),
    url(r'^report/top/so/fullfill/rate/qty/(?P<top>\d+)/$',
        views.ReportSOFullfillInProgress.as_view(), name='top_so_fullfill_in_progress_report'),
